    ...
    return (
        <div className='modal'>
            <div className='container-fliud'>
                <div className='row'>
                    <img className='col-md-6' src={test.img1} alt='products 1' />
                    <div className='col-md-6'>
                        <h3 className='fs-3'>{test.name}</h3>
                        <p>{test.short_desc}</p>
                        <Link className='btn btn-dark'><i className="fa-solid fa-cart-flatbed me-1"></i>View Detail</Link>
                    </div>
                </div>
            </div>
        </div>
